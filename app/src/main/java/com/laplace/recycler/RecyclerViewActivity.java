...
import com.laplace.Adapter.RecyclerAdapterDemo;
...
public class RecyclerViewActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void buttonFun() {
        ...
        RecyclerAdapterDemo recyclerAdapterDemo = new RecyclerAdapterDemo(getLayoutInflater().getContext(), data, imgList);
